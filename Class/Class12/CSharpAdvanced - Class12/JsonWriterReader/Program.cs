...
namespace JsonWriterReader
{
    class Program {
        ...
        static void Main(string[] args) { 
            ...
            string path = @"C:\Users\Hristijan.nikoloski\Desktop\Hristijan.Nikoloski\advancedC#\Class\Class12\GeneratedFiles\videogames.json";

            // Write JSON directly to a file
            File.WriteAllText(path, videogameRatings.ToString()); 

            //write JSON with JsonTextWriter
            path = @"C:\Users\Hristijan.nikoloski\Desktop\Hristijan.Nikoloski\advancedC#\Class\Class12\GeneratedFiles\videogames2.json";
            ...
            path = @"C:\Users\Hristijan.nikoloski\Desktop\Hristijan.Nikoloski\advancedC#\Class\Class12\GeneratedFiles\JsonPersonsWritten.json";
